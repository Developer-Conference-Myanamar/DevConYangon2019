...
import org.devconmyanmar.devconyangon.feature.about.info.sponsor.SponsorFeatureModule
 ...
 */
@Module(includes = [SponsorFeatureModule::class, MyAgendaFeatureModule::class, ScheduleFeatureModule::class])
